...
results = {}
atoms.calc = AceFFCalculator(model_file=hf_hub_download(repo_id='Acellera/AceFF-1.0', filename='aceff_v1.0.ckpt'))
results['aceff-1.0'] = atoms.get_potential_energy()
atoms.calc = AceFFCalculator(model_file=hf_hub_download(repo_id='Acellera/AceFF-1.1', filename='aceff_v1.1.ckpt'))
results['aceff-1.1'] = atoms.get_potential_energy()
atoms.calc = AceFFCalculator(model_file=hf_hub_download(repo_id='Acellera/AceFF-2.0', filename='aceff_v2.0.ckpt'))
